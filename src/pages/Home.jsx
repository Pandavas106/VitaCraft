  ...
  return (
    <div className="overflow-x-hidden mt-19">
      ...
      <div className="bg-[#D0F6FE] flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20 py-10 relative">
        <img src={D1} alt="" className="h-16 w-16 absolute top-20 left-2 hidden md:block" />
        <img src={D2} alt="" className="h-32 w-40 absolute top-10 right-2 hidden md:block" />
        ...
        <div className="text-center lg:text-left max-w-xl space-y-6">
          <h1 className="text-3xl md:text-5xl font-bold tracking-wide font-[Hanuman] text-black">
            Create Your Perfect Resume in <br className="hidden md:block" /> Minutes
          </h1>
          <p className="text-lg md:text-2xl font-[Hanuman] text-black tracking-wider">
            Design a professional resume that stands out with ease — no experience needed
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-10 items-center justify-center lg:justify-start mt-6">
            <div className="flex items-center gap-4">
              <img src={ATS_Score} alt="ATS Score" className="h-16 w-20 object-contain" />
              <p className="text-xl font-normal">ATS Score <br /> Checker</p>
            </div>
            <div className="flex items-center gap-4">
              <img src={CatTemp} alt="Cat Temp" className="h-20 w-20 object-contain" />
              <p className="text-xl font-normal">Categorical <br /> Templates</p>
            </div>
          </div>
        </div>

        <img src={MainP} alt="Resume" className="w-full max-w-md md:max-w-lg lg:max-w-xl object-contain mt-10 lg:mt-0" />
      </div>

      {/* Template Section */}
      <div className="bg-white px-6 py-12 flex flex-col-reverse md:flex-row items-center justify-center gap-10">
        <img src={Templates} alt="" className="w-full max-w-lg object-contain" />
        <div className="text-center md:text-left space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold font-[Hanuman]">Pick Your Perfect Resume Template!</h2>
          <p className="text-lg md:text-2xl font-[Hanuman] tracking-wide">
            Stand out with a resume that speaks for you! Choose from our sleek, modern, and professional templates to land your dream job.
          </p>
          <button className="bg-[#406B98] text-white px-6 py-3 rounded text-base md:text-lg font-semibold">
            Browse Templates
          </button>
      ...
      <div className="bg-[#446D9A] px-6 py-12 text-center text-white">
        <h2 className="text-3xl md:text-5xl font-bold font-[Hanuman] mb-2">Cover Pages</h2>
        <p className="text-lg md:text-2xl font-[Hanuman] mb-6">Design a Cover Page That Stands Out!</p>
        <CoverPageCard />
      </div>
      ...
      <div className="bg-white px-6 py-12 flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="space-y-4 max-w-2xl">
          <h2 className="text-3xl md:text-4xl font-bold font-[Hanuman]">ATS Score Checker – Get Hired Faster!</h2>
          <p className="text-lg md:text-2xl font-[Hanuman]">
            Make sure your resume passes the ATS test! Get an instant score and expert tips to improve your chances.
          </p>
          <ul className="space-y-3 pl-5 text-left list-disc text-lg">
            <li>✅ Job Match Score: Compares your resume against the job description for relevance.</li>
            <li>✅ Keyword Optimization: Ensures your resume includes important job-specific keywords.</li>
            <li>✅ Clear Section Headings: Ensures sections like "Work Experience" and "Skills" are ATS-friendly.</li>
            <li>✅ File Compatibility: Checks if your resume is in ATS-friendly formats (.docx, .pdf).</li>
            <li>✅ Bullet Point Readability: Makes sure content is structured for easy ATS scanning.</li>
          </ul>
      ...
      <div className="bg-[#D0F6FE] px-6 py-12">
        <h2 className="text-3xl md:text-5xl font-bold font-[Hanuman] mb-6">Frequently Asked Questions (FAQ'S)</h2>
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div key={index} className="bg-white p-4 rounded shadow-md">
              ...
              >
                {faq.question}
                {openIndex === index ? <FaMinus size={18} /> : <FaPlus size={18} />}
              </div>
              {openIndex === index && (
                <p className="mt-2 text-gray-700 text-base md:text-lg">{faq.answer}</p>
              )}
            </div>
          ))}
        </div>
      ...
      <footer className="bg-[#446D9A] text-white px-6 py-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <p className="text-sm">Hotel Reservation: <strong>123-456-7890</strong></p>
            <p className="text-sm">Ticket Office: <strong>123-456-7890</strong></p>
          </div>
          <div>
