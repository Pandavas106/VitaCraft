...
const ATSCheckerPage = () => {
  ...
  return (
    <div className="bg-[#D0F6FE] min-h-screen p-6">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-bold font-[Hanuman] mb-4">ATS Score Checker</h1>
        <p className="text-lg md:text-2xl font-[Hanuman]">
          Make sure your resume passes the Applicant Tracking System test and lands you that interview!
        </p>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-8">
        ...
        {!results && (
          ...
          >
            <h2 className="text-2xl font-bold font-[Hanuman] mb-6">Upload & Analyze</h2>
            
            <div className="space-y-6">
              <div>
                <label className="block text-lg mb-2 font-semibold">Upload your resume</label>
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer hover:border-[#406B98]" onClick={() => fileInputRef.current.click()}>
                  <input 
                    type="file" 
                    ref={fileInputRef}
                  ...
                  {file ? (
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400 mt-2">Supports PDF, DOC, DOCX</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div>
                <label className="block text-lg mb-2 font-semibold">Paste job description</label>
                <textarea 
        ...
        {results && (
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold font-[Hanuman]">Your ATS Score Results</h2>
              <button 
                onClick={handleReset}
            ...
            <div className="flex flex-col justify-center items-center sm:flex-row gap-6 mb-8">
              <div className="bg-[#D0F6FE] px-4 py-12 rounded-lg text-center flex-1">
                <div className="text-5xl font-bold text-[#406B98] mb-2">{results.score}%</div>
                <div className="text-lg font-semibold">Overall ATS Score</div>
              </div>
              
              <div className="grid grid-cols-2 gap-4 flex-1">
                <div className="bg-gray-50 p-3 rounded text-center">
                  <div className="text-2xl font-bold text-[#406B98]">{results.keywordMatch}%</div>
                  <div className="text-sm">Keyword Match</div>
                </div>
                <div className="bg-gray-50 p-3 rounded text-center">
                  <div className="text-2xl font-bold text-[#406B98]">{results.sectionHeadings}%</div>
                  <div className="text-sm">Section Headings</div>
                </div>
                <div className="bg-gray-50 p-3 rounded text-center">
                  <div className="text-2xl font-bold text-[#406B98]">{results.fileCompatibility}%</div>
                  <div className="text-sm">File Compatibility</div>
                </div>
                <div className="bg-gray-50 p-3 rounded text-center">
                  <div className="text-2xl font-bold text-[#406B98]">{results.readability}%</div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {results.missingKeywords.map((keyword, idx) => (
                    <span key={idx} className="bg-red-50 text-red-600 px-3 py-1 rounded-full text-sm">
                      {keyword}
                    </span>
                  ))}
                </div>
        ...
        >
          <h2 className="text-2xl font-bold font-[Hanuman] mb-4">Why ATS Matters</h2>
          
          <div className="space-y-4 mb-6">
            <p>
              75% of resumes are rejected by ATS before a human ever sees them. Our tool helps you beat the system.
            </p>
          ...
          <div className="text-center">
            <p className="font-medium mb-4">Need more help with your resume?</p>
            <button onClick={navigateToTemplates} className="bg-white text-[#406B98] px-6 py-2 rounded font-semibold hover:bg-gray-100 transition-colors">
