...
export default function CoverLetter4({
  coverLetterContent,
  userData,
  jobDetails,
  isEditing,
    ...
    if (isLoading) {
      ...
      return (
        <textarea
          ...
          className="w-full bg-white p-4 rounded border border-gray-300 min-h-64 whitespace-pre-wrap font-serif text-base leading-relaxed resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
      );
    } else {
      ...
      >
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="text-right">
            <div className="flex items-center justify-end gap-1 font-medium text-blue-800">
        ...
        {!isLoading && (
          <div className="mt-8">
            ...
            <div className="mt-6 font-bold relative">
              ...
              <div className="absolute -bottom-2 left-0 w-32 h-1 bg-blue-500 opacity-30"></div>
            </div>
          </div>
        )}
