    ...
    <div className="bg-white max-w-4xl mx-auto shadow-lg rounded-lg overflow-hidden print:shadow-none">
      ...
      {previewMode === "modern" && (
        ...
        >
          ...
          <div className="bg-gradient-to-r from-purple-700 to-purple-900 text-white py-8 px-8 print:py-6">
      ...
      {previewMode === "classic" && (
        ...
        >
          <div className="p-8 font-serif max-w-3xl mx-auto">
            ...
            {/* Greeting */}
            <div className="mb-6">{/* <p>Dear Hiring Manager,</p> */}</div>
          ...
          * {
          ...
          .bg-gradient-to-r {
            background: rgb(
              ...
              58,
              242
            ) !important; /* fallback if gradient doesn't print */
          }
